...
public class TipoParametroPersonaController {
	...
	public String crearTipoParametroPersona(Map<String, Object> model) {
		...
		model.put("tipoParametroPersonaEntity", tipoParametroPersonaEntity);
		model.put("lblTituloFormTipoParametroPersona", "Tipo Parametro Persona");
	...
	public String editarTipoParametroPersona(@PathVariable(value = "id") Long id, Map<String, Object> model, RedirectAttributes flash) {
	...
	public String guardarTipoParametroPersona(@Valid TipoParametroPersonaEntity tipoParametroPersonaEntity, BindingResult result, Model model,
	...
	public String eliminarTipoParametroPersona(@PathVariable(value = "id") Long id, RedirectAttributes flash) {
=======
